...
// database.js nằm ở thư mục gốc bot
const {
    getPlayer,
    updatePlayer
} = require("../database");
...
async function dungDanDuoc(
    ...
    // Nếu item có effect dạng object
    if (
        item.effect &&
        ...
        try {
            ...
            updatePlayer(
                userId,
                {
                    ...
                    kinhNghiem: player.kinhNghiem,
                    cong: player.cong,
                    thu: player.thu,
                    phapBao: player.phapBao,
                    congPhap: player.congPhap,
                    tuLuyenBonus:
                        player.tuLuyenBonus,
                    linhThuDangSuDung:
                        player.linhThuDangSuDung
